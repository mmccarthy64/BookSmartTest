...
User.create(email: "test1@examples.com", password: "abcd1234", first_name: "Bill", last_name: "S")
User.create(email: "test2@examples.com", password: "abcd1234", first_name: "Fred", last_name: "X")
User.create(email: "test3@examples.com", password: "abcd1234", first_name: "Linda", last_name: "R")
User.create(email: "test4@examples.com", password: "abcd1234", first_name: "Sally", last_name: "T")
